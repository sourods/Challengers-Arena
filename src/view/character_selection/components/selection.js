...
export default class Selection extends Component {
    selectClass(selectedClass) {
        Game.buildPlayer(selectedClass);
        console.log(Game.Player);
    }
    render() {
        return (
            <section className="interface">
                {/* <ClassInfo portrait={} alt='warrior'>
                ...
                <div className="class" onClick={e => this.selectClass('Warrior')}>
                ...
                <div className="class" onClick={e => this.selectClass('Rogue')}>
                ...
                <div className="class" onClick={e => this.selectClass('Mage')}>
                ...
                <div className="class" onClick={e => this.selectClass('Hunter')}>
